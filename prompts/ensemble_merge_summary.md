...
역할별 규칙 (summary)
이 역할은 **커뮤니티 요약문** 입니다. 후보에 공통으로 나오는 내용을 중심으로 한 문단으로 합치고, 한 후보에만 있는 주장은 넣지 않습니다.

이 파일(prompts/ensemble_merge_summary.md)은 **summary 역할 전용** 취합 규칙입니다. 지우면 공용 prompts/ensemble_merge.md 가 쓰입니다.
