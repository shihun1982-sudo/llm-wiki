...
각 구성 요소가 **어떤 요청에 대한 답인지** 를 한 장에 정리한 것입니다. 최초 설계는 [legacy/ARCHITECTURE.md](legacy/ARCHITECTURE.md), 최신(v3) 구조는 [ARCHITECTURE_V3.md](ARCHITECTURE_V3.md),
요청 원문은 [REQUESTS_AND_TRENDS.md](REQUESTS_AND_TRENDS.md) 를 참조하세요. 재구현용 상세 사양은 [REBUILD_SPEC.md](REBUILD_SPEC.md), 요구사항 중심 브리프는 [IMPLEMENTATION_BRIEF.md](IMPLEMENTATION_BRIEF.md) 입니다.
...
## 14. [R-K] 트렌드 보고서 반영 현황 (docs/REQUESTS_AND_TRENDS.md B 기준)
