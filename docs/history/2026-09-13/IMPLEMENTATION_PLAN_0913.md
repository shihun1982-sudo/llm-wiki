...
> **상태: 확정·구현 완료 (2026-09-13).** D3 은 "tool 스펙 없음 → 범용 어댑터 + mock" 으로, D14 는 "4096d 기본 유지 + 모든 차원 지원 + float16 옵션 + 캐시" 로 확정. 결과 문서: [BRINGUP_GUIDE.md](../../BRINGUP_GUIDE.md) · [ARCHITECTURE_V3.md](../2026-09-15/ARCHITECTURE_V3.md) · [CLI_FLOWS.md](../../CLI_FLOWS.md) · [CORPUS_CONTRACT.md](../../CORPUS_CONTRACT.md) · `llmwiki_guide.html`.
...
| `docs/history/2026-09-15/ARCHITECTURE_V3.md` | 전체 구조 도식(Mermaid), 데이터 모델, 각 플로우(build/query/evolve/watch/trial/forensic) 단계 설명, 토글·튜닝·프로파일 대응표 |
