...
> 직전 회차는 [VERIFICATION_0915.md](../2026-09-15/VERIFICATION_0915.md), 남은 작업 목록은 [HANDOVER_0916.md](HANDOVER_0916.md).
...
- **판정에는 넣지 않는다.** `verify_monkey.py` 는 설계상 폭격 직후의 거절을 판정에서 제외하고
  ([VERIFICATION_0915.md](../2026-09-15/VERIFICATION_0915.md) §5 의 근거 — 버려진 요청의 서버 스레드가 `queue_timeout_s`(120초)로
...
| `docs/history/2026-09-16/VERIFICATION_0916.md` | 이 문서 |
