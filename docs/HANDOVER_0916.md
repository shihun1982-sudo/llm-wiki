...
- 검증: `python tools/verify/verify_mcp.py [--quick]` 를 [VERIFICATION_0915.md](VERIFICATION_0915.md) 의 스크립트 목록과
...
[VERIFICATION_0915.md](VERIFICATION_0915.md) §6 과 같은 형식으로 결과를 기록할 것.
