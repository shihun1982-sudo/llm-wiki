...
| 회차 | 무엇 |
|---|---|
| [2026-09-24](docs/history/2026-09-24/CODE_REVIEW_0924.md) | **가장 최근** — 09-23 회차의 **사후 코드 리뷰와 전체 검증**. 결함 10건(정상 종료 때 원장 유실 · 테스트의 실사용 원장 오염 · 다중 프로세스 원장 줄 깨짐 · cp949 콘솔에서의 거짓 FAIL 등)과 재발 방지 규칙 9가지 |
